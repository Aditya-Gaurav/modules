  ...
  function ($stateProvider) {
    ...
    $stateProvider
      ...
      .state('dashboards.details', {
        ...
        data: {
          roles: ['admin', 'root', 'partner', 'l1ops'],
          parent: 'ontapHealth'
        }
      })
      ...
      .state('dashboards.infinidatDetails', {
        url: '/infinidat-health/:type',
        templateUrl: 'modules/dashboards/client/views/infinidat-health-dashboards.client.view.html',
        controller: 'DashboardsInfinidatHealthController',
        data: {
          roles: ['admin', 'root', 'partner', 'l1ops'],
          parent: 'infinidatHealth'
        }
      })

...
angular.module('dashboards').controller('DashboardsInfinidatHealthController', ['$scope', '$stateParams', '$filter', '$http', '$interval', 'Authentication', 'InfinidatHealth', 'Flash',
  function ($scope, $stateParams, $filter, $http, $interval, Authentication, InfinidatHealth, Flash) {
    ...
    var results = InfinidatHealth.query({"type":$scope.type});

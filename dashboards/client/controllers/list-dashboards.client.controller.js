...
angular.module('dashboards').controller('DashboardsListController', ['$scope', '$location', '$filter', '$http', '$interval', 'Authentication', 'Dashboards', 'Sites', 'Subtenants', 'OntapServers', 'Storagegroups', 'Flash',

...
angular.module('ontap-storageunits').controller('OntapStorageunitsListController', ['$scope', '$filter', '$interval', 'NgTableParams', 'Authentication', 'OntapStorageunits',
  function ($scope, $filter, $interval, NgTableParams, Authentication, OntapStorageunits) {
    ...
    $scope.rowsToDisplay = function () {
      $scope.tableParams = new NgTableParams({
        ...
        getData: function($defer, params) {
          ...
          OntapStorageunits.query(pollingParams, function (data) {

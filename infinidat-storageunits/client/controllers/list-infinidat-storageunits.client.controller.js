...
angular.module('infinidat-storageunits').controller('InfinidatStorageunitsListController', ['$scope', '$filter', '$interval', 'NgTableParams', 'Authentication', 'InfinidatStorageunits',
  function ($scope, $filter, $interval, NgTableParams, Authentication, InfinidatStorageunits) {
    ...
    $scope.rowsToDisplay = function () {
      ...
      $scope.tableParams = new NgTableParams({
        ...
        getData: function($defer, params) {
          ...
          InfinidatStorageunits.query(pollingParams, function (data) {

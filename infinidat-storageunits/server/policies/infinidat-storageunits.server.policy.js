...
exports.invokeRolesPolicies = function () {
  acl.allow([{
    ...
    allows: [{
      resources: '/api/infinidat-storageunits',
      permissions: ['post']
    }]
  }, {
    ...
    allows: [{
      resources: '/api/infinidat-storageunits/:infinidatStorageunitId',
      permissions: ['get']
    }]
  }, {
  ...
  },
  {
    roles:  featuresSettings.roles.infinidatStorageunit.create,
    allows: [{
      resources: '/api/infinidat-storageunits/getListOfIgroups',
      permissions: ['get']
    }]
  },
  {
...
/**
 * Check If infinidat-storageunits Policy Allows
 */

...
angular.module('jobs').controller('JobListController', ['$scope', '$interval', '$filter', 'Jobs', 'Authentication', 'NgTableParams', 'modalService', 'Flash', '$sanitize', '$uibModal',
  function ($scope, $interval, $filter, Jobs, Authentication, NgTableParams, modalService, Flash, $sanitize, $uibModal) {
    ...
    //Modal Business Logic Code
    $scope.viewJobDetailsModal = function(job) {
      $scope.modalDataEnabled = false;

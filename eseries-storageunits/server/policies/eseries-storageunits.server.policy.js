...
exports.invokeRolesPolicies = function () {
  acl.allow([{
    roles: featuresSettings.roles.eseriesStorageunit.create,
    allows: [{
      resources: '/api/eseries-storageunits',
      permissions: ['post']
    }]
  }, {
    roles: featuresSettings.roles.eseriesStorageunit.list,
    allows: [{
      resources: '/api/eseries-storageunits',
      permissions: ['get']
    }]
  }, {
    roles: featuresSettings.roles.eseriesStorageunit.read,
    allows: [{
      resources: '/api/eseries-storageunits/:eseriesStorageunitId',
      permissions: ['get']
    }]
  }, {
    roles: featuresSettings.roles.eseriesStorageunit.update,
    allows: [{
      resources: '/api/eseries-storageunits/:eseriesStorageunitId',
      permissions: ['put']
    }]

...
exports.create = function (req, res) {
  var serverCreateJob;
  var dbWfa = require('./ontap-servers.server.wfa.db.read');
  var fetchInfo = require('./ontap-servers.server.fetchInfo');
  var clientWfa = require('./ontap-servers.server.wfa.svm.create');
  ...
  console.log('SVM Create: server.site: ', server.site);
  Cluster.findById(server.cluster).populate('cluster','name code').exec(function (err, cluster) {
    ...
    console.log('SVM Create: Cluster.findById(): cluster: ',  cluster);
            ...
            if (err) {
              ...
              server.populate('cluster', 'name uuid', function (err, serverPopulated) {
                if (err){
                  ...
                  console.log('SVM Create: Server Populated: ', server);
  ...
  function createSvm(clusterName) {
    ...
    clientWfa.svmCreateExec(args, function (err, resWfa) {
      if (err) {
        ...
        console.log('SVM Create: Response from WFA: ' , resWfa);
...
exports.update = function (req, res) {
  ...
  var clientWfa = require('./ontap-servers.server.wfa.svm.update');
  ...
  if (req.body.fromFix && _.includes(req.user.roles, 'root')) {
    ...
    console.log('SVM Fix: Server Object: ', server);
    console.log('SVM Fix: Request Body: ', req.body);
    ...
    Job.create(req, 'ontap-server', function(err, updateJobRes) {
  ...
  console.log('SVM Update: Server Object: ', server);
  console.log('SVM Update: Request Body: ' + req.body);
          ...
          if (err) {
            ...
            server.populate('tenant','name code')
              ...
              if (err){
                ...
                console.log('SVM Update: Server Populated: ', server)
                sendServerResponse(res, server);
  ...
  function updateSvm() {
    ...
    console.log('SVM Update: Args for WFA', args);
    ...
    clientWfa.svmUpdateExec(args, function (err, resWfa) {
      if (err) {
        ...
        console.log('SVM Update: Response for WFA: ', resWfa);
...
exports.delete = function (req, res) {
  var clientWfa = require('./ontap-servers.server.wfa.svm.delete');
  var serverDeleteJob;
  var server = req.server;
  ...
  function deleteServer() {
    Job.create(req, 'ontap-server', function(err, deleteJobRes) {
